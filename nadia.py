...
if page == "Home":
    ...
    # Student Details
    name = st.text_input("Your Name", "GIHOZO Nadia")
    ...
    project_data = {
        "Year 1 Project": {
            "📊 Memo_Profile Project": {
                ...
                "link": "https://github.com/gihozo2003/student_portifolio"
            }
        },
        "Year 2 Project": {
            "🤖 Cleaning_Dashboard": {
...
# Contact Page
    ...
    st.write("🔗 [https://www.linkedin.com/in/gihozo-nadia-80a2bb355/)")
    st.write("[GitHub Repository](https://github.com/gihozo2003/student_portifolio)")

st.sidebar.write("---")
st.sidebar.write("Designed by Nadia under the supervision of Mclement")
